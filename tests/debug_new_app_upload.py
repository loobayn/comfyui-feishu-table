...
def debug_upload_error(access_token):
    ...
    files = {
        'file': ('test_new_app.png', image_bytes, 'image/png')
    }
    ...
    data_combinations = [
        ...
        {'type': 'image', 'name': 'test_new_app.png'},
        {'type': 'image', 'parent_node': 'root', 'name': 'test_new_app.png'},
        {}
    ]
...
def main():
    ...
    if success:
        ...
        print("❌ 所有参数组合都失败了")
        print("\n🔍 问题分析:")
        print("1. 新App ID仍然缺少drive权限")
        print("2. 或者权限配置有问题")
        print("3. 需要检查新App的权限设置")
